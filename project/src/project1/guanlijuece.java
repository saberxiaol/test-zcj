...
public class guanlijuece {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("applyTitle")).sendKeys("自动化测试001");
       ...
       // Thread.sleep(3000);
        ...
        driver.findElement(By.cssSelector("#xtable > tbody > tr.redtitleNew.flagpiid\3a 78fadfef-34fb-4ed0-b6bf-86fa2ece988f > td > [title~=自动化测试001]")).click();
